# MODEL1310110016: MODEL1310110016
...
`pip install git+https://github.com/biomodels/MODEL1310110016.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110016.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110016 as model`
...
The model of cerebellum cells in molecular layer metabolism is derived from
...
and identified by:
[MODEL1310110016](http://identifiers.org/biomodels.db/MODEL1310110016) .
